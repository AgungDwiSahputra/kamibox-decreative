	...
	<style type="text/css">
      ...
      .segmen-button-blog .btn-blog{
		...
		@media screen and (max-width: 850px){
			header, .home, .produk, .tentang-kamibox{
				background: none;
			}
	...
	<section class="home">
		<div class="container home-wrapper ">
			<div class="content-left" data-aos="fade-right">
				<h2 class="heading">Daur Ulang Semua <p>Jenis <span style="color:#069B45">Sampah</span></p></h2>
	...
	<section class="tentang-kamibox">
		<div class="container tentang-kamibox-wrapper">
			...
			<div class="content kb-right">
				<div><h2 class="heading-kmb">Apa itu Kamibox?</h2></div>
				<p><img src="assets/images/gai2.png"></p>
				<div><p class="subheading-kmb">Kamibox merupakan perusahaan yang bergerak di bidang pengumpulan pengolahan sampah daur ulang	di jakarta, khususnya kardus bekas dan kertas bekas Jakarta. Dengan Tahline “We Value Your Waste”, Kamibox membantu masyarakat dan perusahaan di Indonesia dengan cara membeli sampah daur ulang yang mereka miliki sehingga sampah tersebut bisa menjadi penghasilan tambahan bagi mereka. Kami menerima ...</p></div>
