        ...
        <script type="text/javascript">
            ...
            function drawChartItem() {
                ...
                var jsonDataItem = $.ajax({
                    url: "http://localhost/decreative_project/kamibox-decreative/pemasok/getDataItem.php",
                    type: "POST",
                    dataType: "json",
                    async: false
                }).responseText;
                    ...
                    <div class="row2 card-grafik">
                        ...
                        <div class="content-grafik">
                            ...
                            <?php
                                ...
                                //tampilkan chart
                                echo "<div id='Item_chart_div' style='width: 400px; height: 200px;'></div>";
                            }
                ...
                <div class="cards">
                    <div class="row2 card-transaksi">
                        ...
                        <div class="content-transaksi">
                            ...
                            $cekjmltr = mysqli_num_rows($query3);
                            if ($cekjmltr == 0) {
