...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Bulan Mei 2022 pada 13.02
...
CREATE TABLE `grafik` (
  ...
  `tgl_grafik` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `total_penjualan` int(50) NOT NULL,
  `kertas` int(20) NOT NULL,
  `plastik` int(20) NOT NULL,
  `logam` int(20) NOT NULL,
  `kaca` int(20) NOT NULL
...
INSERT INTO `grafik` (`id_grafik`, `tgl_grafik`, `total_penjualan`, `kertas`, `plastik`, `logam`, `kaca`) VALUES
(1, '2022-05-28 20:07:43', 7650500, 0, 0, 0, 0);
...
(62, 1, 48, '2022-05-28', 'Annisa Sukma Putri', 'jl raya dringu', '085732100010', 'ceamey@yahoo.co.id', '2022-05-28 12:23:12');
...
CREATE TABLE `rw_transaksi` (
  `id_rw_transaksi` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `rw_transaksi`
--

INSERT INTO `rw_transaksi` (`id_rw_transaksi`, `Tgl_beli`, `nm`, `berat`, `alamat`, `no_invoice`, `total_tr`, `status_tr`) VALUES
(1, '2022-05-28 19:53:13', 'Trisna Amijaya', 90, 'Jl Panglima Sudirman', '00001', 125000, '1'),
(2, '2022-05-27 19:55:02', 'Putra Sandika', 75, 'Jl Mulyadadi no 7', '00002', 250000, '1'),
(3, '2022-05-26 19:56:30', 'Mitha Nur Saka', 70, 'Jl Melati no 9', '00003', 80000, '1'),
(4, '2022-05-28 22:26:11', 'Dwi Mustika', 55, 'Jl Ganggang Mulia no 4, Bandar, Jakarta Barat', '00004', 250500, '1'),
(5, '2022-05-28 22:27:29', 'Fajar Dwi Wicaksono', 30, 'Jl Ahmad Yani no 28, Kec Mangun, Kab Badung, Jakarta Barat', '00005', 230000, '1'),
(6, '2022-05-28 22:29:30', 'Habibah Lutfiana', 75, 'Jl Marditresno no 55, Dringu, Jakarta Barat', '00006', 450000, '1');
...
(1, 'annisasukmaputri@gmail.com', NULL, 'Kazanuchi Basuki', 'Jl Raya Dringu no 48, Kec. Dringu, Kab. Probolinggo 64217 Provinsi Jawa Timur', '085735020915', 2, '1', '2022-04-24 07:10:48', '2022-04-24 07:10:48', '2022-05-28 14:20:44'),
(48, 'ceamey@yahoo.co.id', NULL, 'Annisa Sukma Putri', 'Jl Kyai Ageng no 5, Kec. Badas, Kab. Kediri 64217 Provinsi Jawa Timur', '085732100010', 3, '1', '2022-05-21 20:55:32', '2022-05-21 20:55:32', '2022-05-28 19:58:27');
...
ALTER TABLE `rw_transaksi`
  ADD PRIMARY KEY (`id_rw_transaksi`);
...
--
ALTER TABLE `grafik`
  MODIFY `id_grafik` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `input_item`
  MODIFY `id_input_item` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
...
--
ALTER TABLE `rw_transaksi`
  MODIFY `id_rw_transaksi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
